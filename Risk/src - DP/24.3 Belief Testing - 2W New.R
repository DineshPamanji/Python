...
dark_green_band <- c('1_1','1_2','1_3','1_4','2_1','2_2','2_3','3_1','4_1')
light_green_band <- c('4_2','4_3','2_4','3_2','3_3')
orange_band <- c('5.1_4','5.1_5','5.2_3','5.2_4','2_5','2_6','3_5','3_6','4_5','4_6')
red_band <- c('5.1_6','5.2_5','5.2_6')
...
write_xlsx(output_list, "data//output//belief_testing//vcheck//belief_testing_2W_New_Jun_22.xlsx")
...
write_xlsx(output_list, "data//output//belief_testing//vcheck//Summary_belief_testing_2W_New_Jun_17.xlsx")
...
belief_testing_2W <- belief_testing_adj %>% dplyr::select(selected_colnames)
save(belief_testing_2W, file = "data//output//reason_code//2W_New//belief_testing_2W.rdata")
# save(belief_testing_2W, file = "data//output//reason_code//2W_New//belief_testing_2W_dpd_check.rdata")
rm(list=ls())
...
testing_data <- belief_testing_adj %>% dplyr::select(testing_cols)
