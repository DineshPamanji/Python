...
dev_data_combined <-
  model_data_2W_New_A_R %>% filter(UID %notin% unique(oot_data_combined$UID) &
                                 (Category %in% c('SAL','SENP','SEP')) &
                                   (tag %in% c('A','R1')))
...
## 4.5 save outputs
save_csv_output(bivar_2W_combined_dev, "bivariates//2W_New//A_R//bivar_2W_combined_dev.csv")
save_csv_output(bivar_2W_combined_oot, "bivariates//2W_New//A_R//bivar_2W_combined_oot.csv")


# save_csv_output(bivar_2W_combined_dev, "bivariates//2W_New//A_R//bivar_2W_combined_dev_R1.csv")
# save_csv_output(bivar_2W_combined_oot, "bivariates//2W_New//A_R//bivar_2W_combined_oot_R1.csv")
# 
# 
# save_csv_output(bivar_2W_combined_dev, "bivariates//2W_New//A_R//bivar_2W_combined_dev_R2.csv")
# save_csv_output(bivar_2W_combined_oot, "bivariates//2W_New//A_R//bivar_2W_combined_oot_R2.csv")
...
# 
# R1_data <- model_data_2W_New_A_R %>% filter(tag == 'R1')
