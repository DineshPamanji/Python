...
date_index <- fread("data//mapping//year_mon_index.csv")
...
save(disbursals_final,
     file = file.path(
             ...
             "ADS_data",
             "disbursals_final_all_2W_RF.rdata"
     )
)

# save(disbursals_final, file = file.path("data//intermediate//ADS_data//disbursals_final_all_2W_RF.rdata"))
